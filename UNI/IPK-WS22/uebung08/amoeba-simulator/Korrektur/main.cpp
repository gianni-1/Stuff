...
/* -1.5 P
Es wird nirgendwo die Größe oder die Farbe einer Amoebe von euch verändert.
*/
...
int main() {
  ...
  /*
  Bitte gebt euren Objekten (also in diesem Fall den Amoeben) einen sinnvollen Namen
  und nicht nur Nummern wie Customamoeba1 bis 4
  */
